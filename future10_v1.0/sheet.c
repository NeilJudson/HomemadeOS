...
{
	/*
	* 重绘屏幕[(vx0,vy0),(vx1,vy1))区域的map
	*/
	int h, bx, by, vx, vy, bx0, by0, bx1, by1;
	unsigned char *buf, sid, *map = ctl->map;					// sid: 图层号码
	struct SHEET *sht;
	if (vx0 < 0) { vx0 = 0; }
	if (vy0 < 0) { vy0 = 0; }
...
{
	/*
	* 重绘屏幕[(vx0,vy0),(vx1,vy1))区域
	* 刷新[h0,h1]区间的图层
	*/
	int h, bx, by, vx, vy, bx0, by0, bx1, by1;
	unsigned char *buf, *vram = ctl->vram, *map = ctl->map, sid; // sid: 图层号码
	struct SHEET *sht;
